...
async function makeRequestWithCache(endpoint: string, params: Record<string, string | undefined> = {}): Promise<CacheResponse> {
...
describe('Cache Performance Validation', () => {
  ...
  describe('Cache Hit Performance', () => {
    it('should achieve <50ms response times for cache hits', async () => {
      const testParams = {
        reference: 'John 3:16',
        language: 'en',
    ...
    it('should show significant performance improvement from cache miss to hit', async () => {
      const testParams = {
  ...
  describe('Cache Metadata Validation', () => {
    it('should include proper cache metadata in all responses', async () => {
  ...
  describe('Multi-Endpoint Cache Performance', () => {
    ...
    endpoints.forEach(({ name, params }) => {
      it(`${name} should have fast cache hits`, async () => {
        // Prime cache
  ...
  describe('Cache Consistency', () => {
    it('should return identical content for cache hits and misses', async () => {
      const testParams = {
    ...
    it('should handle verse ranges consistently in cache', async () => {
      const testParams = {

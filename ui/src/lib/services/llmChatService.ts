...
export class LLMChatService {
	...
	generateMockResponse(userQuestion: string) {
		...
		const lowerQuestion = userQuestion.toLowerCase();
		let mockResponse =
			'🎭 **MOCK RESPONSE - Development Mode** 🎭\n\n**⚠️ OpenAI API Key Not Configured**\n\nThe chat assistant is showing mock responses because the OpenAI API key is not configured in the production environment.\n\n**To Enable Real AI Responses:**\n1. Go to your Cloudflare Pages dashboard\n2. Navigate to Settings > Environment variables  \n3. Add `OPENAI_API_KEY` with your OpenAI API key\n4. Redeploy the project\n\n**What I can help with (once configured):**\n- Scripture interpretation and context\n- Translation word definitions and usage\n- Cross-reference analysis\n- Historical and cultural background\n- Translation principles and methods\n\n**For now, try asking about:**\n- John 3:16\n- What is love?\n- Grace\n- Faith\n- Salvation\n\n---\n⚠️ **This is a pre-written mock response.**\n🔧 **Configure OPENAI_API_KEY in Cloudflare Pages environment variables to get real AI responses.**';

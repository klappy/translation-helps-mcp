<script lang="ts">
	...
	const apiInfo = {
		name: 'Translation Helps MCP API',
		version: VERSION,
		description: 'Bible translation resources and tools',
		...
		endpoints: [
			...
			},
			{
				...
				example: {
					url: `/api/extract-references?text=See John 3:16 and Romans 1:1&version=${VERSION}`,
					response: {
						references: [
							{
								reference: 'John 3:16',
			...
			},
			{
				...
				example: {
					url: `/api/list-available-resources?language=en&organization=unfoldingWord&resource=scripture&version=${VERSION}`,
					response: {
						resources: [
							{
			...
			},
			{
				...
				example: {
					url: `/api/get-context?reference=John%203:16&language=en&organization=unfoldingWord&version=${VERSION}`,
					response: {
						reference: 'John 3:16',
						context: {
			...
			},
			{
				...
				example: {
					url: `/api/fetch-resources?reference=Titus%201:1&language=en&organization=unfoldingWord&version=${VERSION}`,
					response: {
						reference: 'Titus 1:1',
						language: 'en',
						organization: 'unfoldingWord',
			...
			},
			{
				...
				example: {
					url: `/api/fetch-scripture?reference=Titus%201:1&language=en&organization=unfoldingWord&version=${VERSION}`,
					response: {
						scripture: {
			...
			},
			{
				...
				example: {
					url: `/api/fetch-translation-notes?reference=Titus%201:1&language=en&organization=unfoldingWord&version=${VERSION}`,
					response: {
						notes: [
							{
								id: 'tit01-01-abc1',
			...
			},
			{
				...
				example: {
					url: `/api/fetch-translation-questions?reference=Titus%201:1&language=en&organization=unfoldingWord&version=${VERSION}`,
					response: {
						questions: [
							{
								id: 'tit01-01-q1',
			...
			},
			{
				...
				example: {
					url: `/api/fetch-translation-words?reference=Titus%201:1&language=en&organization=unfoldingWord&version=${VERSION}`,
					response: {
						words: [
							{
								id: 'servant',
								term: 'servant',
								definition:
									'A person who serves another person, either by choice or by requirement.',
			...
			},
			{
				...
				example: {
					url: `/api/get-words-for-reference?reference=John%203:16&language=en&organization=unfoldingWord&version=${VERSION}`,
					response: {
						content: [
							{
								term: 'love',
			...
			},
			{
				...
				example: {
					url: `/api/fetch-translation-word-links?reference=Titus%201:1&language=en&organization=unfoldingWord&version=${VERSION}`,
					response: {
						links: [
							{
								word: 'servant',
			...
			},
			{
				...
				example: {
					url: `/api/browse-translation-words?language=en&organization=unfoldingWord&search=love&limit=10&version=${VERSION}`,
					response: {
						words: [
							{
								id: 'love',
		...
		<div class="mb-12 text-center">
			...
			<div class="mt-6 flex items-center justify-center gap-6">
				...
				<div class="flex items-center gap-2">
					...
					<span class="text-sm text-gray-300">{apiInfo.endpoints.length} Endpoints</span>
				</div>
				<div class="flex items-center gap-2">

...
import { handleFetchTranslationNotes, FetchTranslationNotesArgs, } from "./tools/fetchTranslationNotes.js";
import { handleFetchTranslationQuestions, FetchTranslationQuestionsArgs, } from "./tools/fetchTranslationQuestions.js";
...
const tools = [
    ...
    {
        name: "get_context",
        description: "Get contextual information for a Bible reference including themes, cultural background, and theological concepts",
    ...
    try {
        switch (name) {
            case "fetch_scripture":
                return await handleFetchScripture(args);
            case "fetch_translation_notes":
                return await handleFetchTranslationNotes(args);
            case "fetch_translation_questions":
                return await handleFetchTranslationQuestions(args);
            case "get_translation_word":
                return await handleGetTranslationWord(args);
            case "get_context":
                return await handleGetContext(args);
            case "get_languages":
                return await handleGetLanguages(args);
            case "browse_translation_words":
                return await handleBrowseTranslationWords(args);
            case "extract_references":
                return await handleExtractReferences(args);
            case "fetch_resources":
                return await handleFetchResources(args);
            case "get_words_for_reference":
                return await handleGetWordsForReference(args);

...
const SCRIPTURE_BASE_CONFIG: Partial<EndpointConfig> = {
  ...
  dataSource: {
    type: 'dcs-api',
    dcsEndpoint: '/api/v1/repos/{organization}/{language}_{resource}/contents/{book}/{chapter}.usfm',
...
export const FETCH_SCRIPTURE_CONFIG: EndpointConfig = {
  ...
  description: 'Retrieve scripture text for any reference with support for verses, ranges, and chapters',
  ...
  examples: [
    ...
    },
    {
      ...
      expectedContent: {
        contains: ['all things work together', 'called according to', 'predestined'],
        minLength: 200,
        fields: {
          scripture: { text: 'string' },
        },
    ...
    },
    {
      ...
      expectedContent: {
        contains: ['The LORD is my shepherd', 'valley of the shadow', 'goodness and mercy'],
        minLength: 400,
        fields: {
          scripture: { text: 'string' },
        },
...
export const FETCH_UST_SCRIPTURE_CONFIG: EndpointConfig = {
  ...
  description: 'Retrieve Unlocked Simplified Text (UST) scripture with clear, easy-to-understand language',

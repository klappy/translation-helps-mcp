...
export declare class ResourceSync {
     ...
     */
    downloadResource(org: string, lang: string, resourceType: string, onProgress?: (progress: DownloadProgress) => void): Promise<boolean>;
    /**
     ...
     */
    downloadAll(lang: string, org?: string, onProgress?: (status: SyncStatus) => void): Promise<SyncStatus>;
    /**

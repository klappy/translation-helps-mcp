...
export class NetworkDetector {
    ...
    TIMEOUT = 5000; // 5 seconds for network check
    listeners = new Set();
    /**
     ...
     */
    async waitForOnline(timeout = 30000, checkInterval = 2000) {
...
export const waitForOnline = (timeout, checkInterval) => networkDetector.waitForOnline(timeout, checkInterval);
export const onNetworkStatusChange = (callback) => networkDetector.onStatusChange(callback);

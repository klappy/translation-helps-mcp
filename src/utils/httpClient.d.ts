 ...
 */
export declare function createProxyFetch(fetchImpl?: FetchFunction): FetchFunction;
 ...
 */
export declare function addUserAgentHeader(headers?: HeadersInit | Record<string, string>): Record<string, string>;
export {};

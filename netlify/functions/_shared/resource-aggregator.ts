...
export class ResourceAggregator {
  ...
  private async fetchScripture(reference: Reference, options: ResourceOptions): Promise<Scripture | undefined> {
    try {
  ...
  private async fetchTranslationNotes(reference: Reference, options: ResourceOptions): Promise<TranslationNote[]> {
    try {
  ...
  private async fetchTranslationQuestions(reference: Reference, options: ResourceOptions): Promise<TranslationQuestion[]> {
    try {
  ...
  private async fetchTranslationWords(reference: Reference, options: ResourceOptions): Promise<TranslationWord[]> {
  ...
  private async fetchTranslationWordLinks(reference: Reference, options: ResourceOptions): Promise<TranslationWordLink[]> {
    try {
  ...
  private extractVerseFromUSFM(usfm: string, reference: Reference): string {
    try {
      ...
      const versePattern = reference.verse 
        ? new RegExp(`\\\\v ${reference.verse}\\b`) 
        : null;

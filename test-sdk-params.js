...
async function testSDKParameters() {
  ...
  try {
    ...
    console.log('Test 1: Using default parameters (should use "en" and "unfoldingWord")');
    try {
    ...
    console.log('Test 3: Using custom organization parameter (organization="testOrg")');
    try {
    ...
    console.log('Test 4: Using both custom parameters (language="es", organization="testOrg")');
    try {
